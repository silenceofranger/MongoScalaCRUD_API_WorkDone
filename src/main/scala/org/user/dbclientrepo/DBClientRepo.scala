...
object DBClientRepo extends JsonUtils {
...
//  def fetchItem(itemId: Long): Future[Option[Seq[Client]]] = Future {
//    clientDoc.find(equal("id", itemId)
//  }
